...
function Hamburger(bun, bunNum, vegetables, cheese, sauce, meatType, meatQuantity, isSeperatedByBun){
    ...
    this.description = function(){
        return `A hamburger with ${this.bunNum} ${this.bun} bun(s). The hamburger has ${this.vegetables} for vegetables; ${this.cheese} for cheeses; and a mixture of ${this.sauce} for the sauce. The patty is ${this.pattyType} and there are ${this.pattyQuantity} patties ${this.isSeperatedByBun}.`;
    }
}
